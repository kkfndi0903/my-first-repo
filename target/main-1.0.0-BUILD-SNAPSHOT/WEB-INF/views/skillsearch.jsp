...
<html>
	...
	<style>
		...
		.project_list_wrap {position:relative; display:inline-block; width:100%; z-index:1; }
	...
	<body>
		...
		<c:if test="${empty sessionScope.loginId}">
			...
			<a onclick="location.href='./projectmain'">전체</a> | <a onclick="location.href='./projectmozip'">모집중</a> | <a onclick="location.href='./projectrunning'">진행중</a> | <a onclick="location.href='./projectfinish'">완료</a></div>
		...
		<form id="skillsearch" action="./skillsearch" method="post">
			<div style="text-align: center; font-size: 14pt; font-weight: 600;">
			<a onclick="location.href='./projectmain'">전체</a> | <a onclick="location.href='./projectmozip'">모집중</a> | <a onclick="location.href='./projectrunning'">진행중</a> | <a onclick="location.href='./projectfinish'">완료</a> | <a style="color:#424242;" onclick="location.href='./skillsearch'">내분야</a></div>
			<br/>
		</form>
		</c:if>
		...
		<div id="select_container02" style="margin-left:175px;">
